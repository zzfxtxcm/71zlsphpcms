...
$LANG['member_group_publish'] = '允许发布';
$LANG['publish_deny'] = '禁止发布';
$LANG['member_group_upgrade'] = '允许自助升级';
$LANG['member_group_sendmessage'] = '允许发短消息';
$LANG['member_group_publish_verify'] = '发布不需审核';
...
$LANG['allowpostnum'] = '日最大发布数';
$LANG['zero_nolimit'] = '0为不限制';
$LANG['allowpostnum_deny'] = '今日发布已超过限制数';
...
$LANG['points_less_than'] = '您的积分为<font color="red">{point}</font>点，发布发布需要扣除<font color="red">{need_point}</font>点，您可以通过回复评论来获取积分';
$LANG['contributors_checked'] = '发布成功，等待管理员审核';
$LANG['contributors_success'] = '内容已发布！感谢您的发布！';
$LANG['has_been_verified'] = '发布已经通过审核，不允许再次修改！';
$LANG['contribute_del_point'] = '发布扣点';
...
$LANG['online_publish'] = '在线发布';
$LANG['published_content'] = '已发布内容';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录创业在路上,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录创业在路上,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录创业在路上,轻松使用盛大所有服务。';
